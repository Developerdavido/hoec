...
class MemberRegistrationMobile extends StatefulWidget {
  const MemberRegistrationMobile({super.key});

  @override
  State<MemberRegistrationMobile> createState() => _MemberRegistrationMobileState();
}

class _MemberRegistrationMobileState extends State<MemberRegistrationMobile> {
